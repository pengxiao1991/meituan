...
/***/ function(module, exports, __webpack_require__) {
	...
	$.ajax({
		"type":"post",
		"url":"pxdanwei.applinzi.com/php/getsign.php",
	...
	$.post("pxdanwei.applinzi.com/php/getsign.php",{"url":location.href},function(data){
	        var start = data.indexOf("{");
	        var end  = data.indexOf("}");
	        var objData = data.slice(start,end+1);
	        objData = JSON.parse(objData);
	        console.log(objData);
	      	wx.config({
	            ...
	            jsApiList: [
	              ...
	              "chooseImage","scanQRCode","getLocation","onMenuShareQQ"
	            ]
	        });
