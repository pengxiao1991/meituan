		...
		$.ajax({
			...
			$("#like li").each(function(index){
				...
				$(this).jdLoad(function(){
					...
					$(that).find("div.fl img")[0].src = "img/"+data["good"+(index+1)].src;
					$(that).find("h3").html(data["good"+(index+1)].title);
					$(that).find("div.fl").next().next("span").html(data["good"+(index+1)].description);
					$(that).find("p>b").html(data["good"+(index+1)].price);
					$(that).find("p>span").html(data["good"+(index+1)].oldprice);
					$(that).find("p>i>span").html(data["good"+(index+1)].sales);
				});	
